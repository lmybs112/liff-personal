...
function Trigger_infFITS() {
    ...
    var FIXED_PRODUCT_URL = "https://brashop.modemarie.com.tw/SalePage/Index/6538644",
        ...
        FIXED_BRAND = "MDMR",
        // 固定載入 Vercel 上的 MDMR iframe（資源改走 inffits CDN 絕對路徑）
        IFRAME_SRC_BASE = window.INFFITS_IFRAME_SRC || "https://liff-personal.vercel.app/indexwebiframe_CAX_tw_mdmr.html";

    // 試衣頁 → keepbodyinfo：第三方 iframe storage 隔離，需靠 hash / opener 帶身材
    var PENDING_BODY_SYNC = null;
    var OPENER_ORIGIN = "https://liff-personal.vercel.app";
